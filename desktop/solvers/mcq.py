...
def get_content_google(search_text):
    ...
    content = google.search(search_text, lang='it', pages=2)
...
#print(answer("La regina Elisabetta ha preso una decisione simile al consiglio comunale di Los Angeles", ["Niente più pellicce in pelo animale","Niente alcol dopo le 18","Niente tè alle 17"]))
